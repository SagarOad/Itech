...
!(function (a) {
    ...
    d = function (b) {
      ...
      return (
        a(b).each(function () {
          ...
          null === g
            ? d.push(b)
            : 1 >= Math.floor(Math.abs(c - f))
            ? (d[d.length - 1] = g.add(b))
            : d.push(b),
            (c = f);
        }),
        d
  ...
  (a.fn.matchHeight = function (b) {
    ...
    (a.fn.matchHeight._throttle = 80),
    (a.fn.matchHeight._maintainScroll = !1),
      ...
      return (
        ...
        c &&
          (f.each(function () {
            var b = a(this),
              c =
                "inline-block" === b.css("display") ? "inline-block" : "block";
        ...
        a.each(g, function (b, d) {
          ...
          (c && 1 >= f.length) ||
            (f.each(function () {
              var b = a(this),
                c =
                  "inline-block" === b.css("display")
                    ? "inline-block"
                    : "block";
              b.css({ display: c, height: "" }),
                b.outerHeight(!1) > g && (g = b.outerHeight(!1)),
                b.css("display", "");
            }),
            f.each(function () {
              var b = a(this),
              ...
              "border-box" !== b.css("box-sizing") &&
                ((c +=
                  e(b.css("border-top-width")) +
                  e(b.css("border-bottom-width"))),
                (c += e(b.css("padding-top")) + e(b.css("padding-bottom")))),
                b.css("height", g - c);
            }));
        }),
        j.css("display", ""),
        a.fn.matchHeight._maintainScroll &&
          a(window).scrollTop((h / i) * a("html").outerHeight(!0)),
        this
      );
    }),
  ...
  (a.fn.matchHeight._update = function (d, e) {
    ...
    a(window).bind("load", function (b) {
      a.fn.matchHeight._update();
    }),
    a(window).bind("resize orientationchange", function (b) {
      a.fn.matchHeight._update(!0, b);
    });
})(jQuery),
  jQuery(function (a) {
    a(window).load(function () {
      a(".match-height").matchHeight();
    });
  });
