    ...
    <div>
      ...
      <div className="bg-[white] px-6 md:px-24">
        <div className="md:pt-[167px] pt-6 flex flex-col md:flex-row items-center">
          <div>
            <h1 className="main-banner-heading mt-4 text-[48px] md:text-[4.5rem] text-[#212121] font-[nexa] font-bold leading-tight  md:text-left">
            ...
            <p className="leading-normal text-[#212121] opacity-75 mt-6 font-[poppins] text-base md:text-[21px] mb-8 md:text-left">
        ...
        <div className="flex flex-col mt-40">
          <div className="">
            <h1 className="main-banner-heading mb-12 mt-4 text-5xl md:text-[3.5rem] text-[#212121] font-[nexa] font-bold leading-tight">
              We Are
            </h1>
