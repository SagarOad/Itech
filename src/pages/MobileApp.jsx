...
const MobileApp = () => {
  ...
  useEffect(() => {
    ...
    metaDescription.content =
      "Fameitech have offers Mobile application development services for all bussiness to grow your bussiness in this digital world and also provide Andriod, iOS and cross plateform development services.";
  ...
  return (
    <>
      <Helmet>
        <meta
          property="og:image"
          content="https://fameitech.net/assets/mobileDev-a79a6780.png"
        />
      </Helmet>
      ...
      >
            ...
            <div className="px-8  relative flex flex-wrap flex-col md:flex-row justify-between items-center">
              <div className="flex flex-col w-full xl:w-[60%] pr-36 justify-center lg:items-start ">
                ...
                <p className="leading-normal text-[#212121] opacity-75 pr-20 font-sans font-thin text-[20px] md:text-[20px] mb-8 md:text-left">
                  ...
                  startups to large enterprises.If you are looking to create a
                  simple app for your own use or a complex app for your
                  bussiness, there is a mobile app development company that can
                  help you.
                </p>
              </div>
              <div className="w-full relative service-banner-shape xl:w-[40%] rounded-2xl">
                <img
                  src={mobApp}
                  className="w-[600px] absolute top-[-120px]  mx-auto"
                />
              </div>
            </div>
          </div>
        ...
        <div className=" px-8 xl:px-24 py-24 line-banner">
          <div className=" container mx-auto">
            ...
            <div className="grid grid-cols-12">
              <div className="col-span-12 lg:col-span-3 group flex justify-center transition-all    rounded-[50px] items-center  p-8 m-4">
                <div className="px-2 ">
                  <MdOutlineDesignServices className=" text-[92px] mx-auto mb-8 text-white " />
                  <h1 className="text-white text-center text-[26px] font-[nexa] mb-4">
                    User-Centric Design
                  </h1>
                  <p className="leading-normal mt-3 text-white text-center font-[poppins] font-[300] text-[18px] md:text-[18px]">
                    Prioritize intuitive navigation and a clean interface for a
                    seamless user experience
                  </p>
                </div>
              </div>
              <div className="col-span-12 lg:col-span-3 flex group justify-center transition-all   rounded-[50px] items-center  p-8 m-4">
                <div className="px-2 ">
                  <MdSecurity className=" text-[92px] mx-auto mb-8 text-white " />
                  <h1 className="text-white text-center text-[26px] font-[nexa] mb-4">
              ...
              <div className="col-span-12 lg:col-span-3 flex justify-center transition-all   rounded-[50px] group items-center p-8 m-4">
                <div className="px-2 ">
                  <MdUpdate className=" text-[92px] mx-auto mb-8 text-white " />
                  <h1 className="text-white text-center text-[26px] font-[nexa] mb-4">
                    Updates and Support
                  </h1>
                  <p className="leading-normal mt-3 text-white text-center font-[poppins] font-[300] text-[18px] md:text-[18px]">
              ...
              <div className="col-span-12 lg:col-span-3 flex justify-center transition-all   rounded-[50px] group items-center p-8 m-4">
                <div className="px-2 ">
                  <SiAzurefunctions className=" text-[92px] mx-auto mb-8 text-white " />
                  <h1 className="text-white text-center text-[26px] font-[nexa] mb-4">
        ...
        <div className=" relative">
          <div className="container mx-auto py-24">
            <div className="px-8 xl:flex flex-wrap flex-col md:flex-row items-center">
              <div className="w-full basis-2/6 ml-[-100px] xl:ml-[0px] rounded-2xl overflow-hidden">
                <img
                  src={mob3}
                  className="md:w-[700px] xl:absolute top-28 left-0 opacity-100 mx-0"
                />
              </div>

              <div className="flex basis-4/6 flex-col w-full justify-center lg:items-start ">
                <div className="xl:ml-32">
                  <h1 className="main-banner-heading services2-heading mix-blend-multiply mb-2 text-3xl tracking-normal md:text-[3.5rem] text-[#f58020] font-[poppins] opacity-95 font-bold leading-[70px] md:text-left">
                  ...
                  <p className="leading-normal text-[#212121] opacity-75 font-[poppins] font-medium text-base md:text-[18px] md:text-left">
                  ...
                  <div className="pr-0 xl:pr-40">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center mt-12">
                      <div className="border-2 mb-5 border-[#e4563aef] sm:mb-0 py-6 px-8 rounded-full mr-12">
                        <h1 className="text-[24px] font-bold text-[#e4563aef]">01</h1>
                      </div>
                      <div>
                        <h2 className="leading-normal text-[#212121] mb-2 opacity-100 font-[poppins] font-medium text-base md:text-[22px] md:text-left">
                          User-Centric Approach
                        </h2>
                        <p className="leading-normal text-[#212121] opacity-60 font-[poppins] font-medium text-base md:text-[16px] md:text-left">
                          Our apps prioritize seamless user experiences,
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center mt-12">
                      <div className="border-2 mb-5 border-[#e4563aef] sm:mb-0 py-6 px-8 rounded-full mr-12">
                        <h1 className="text-[24px] text-[#e4563aef]">02</h1>
                      </div>
                      <div>
                        <h2 className="leading-normal text-[#212121] mb-2 opacity-100 font-[poppins] font-medium text-base md:text-[22px] md:text-left">
                        ...
                        <p className="leading-normal text-[#212121] opacity-60 font-[poppins] font-medium text-base md:text-[16px] md:text-left">
                          ...
                          high-performance apps that stand out in the
                          competitive market.
                        </p>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-12">
            <div className="col-span-12 lg:col-span-4 flex flex-col justify-evenly items-center">
              <div className="flex flex-col-reverse md:flex-row-reverse lg:flex-row items-center">
                <div>
                  <h2 className="leading-normal text-[#212121] mb-2 opacity-100 font-[poppins] font-medium text-base md:text-[24px] text-center lg:text-right">
                    Conceptualization
                  </h2>
                  <p className="leading-normal text-[#212121] opacity-60 font-[poppins] font-medium text-base md:text-[18px] text-center lg:text-right">
                    Clarify objectives, target audience, and features to outline
                    the app's core concept.
                  </p>
                </div>
                <div className="border-2 border-[#e4563aef] py-6 px-8 mb-3 md:mb-0 rounded-full lg:ml-8 md:mr-8 ld:mr-0">
                  <h1 className="text-[24px] text-[#e4563aef] font-bold">01</h1>
                </div>
              </div>
              ...
              <div className="flex flex-col-reverse md:flex-row-reverse lg:flex-row items-center mt-6 md:mt-0">
                ...
                <div className="border-2 border-[#e4563aef] py-6 px-8 mb-3 md:mb-0 rounded-full lg:ml-8 md:mr-8 ld:mr-0">
                  <h1 className="text-[24px] text-[#e4563aef] font-bold">02</h1>
                </div>
              </div>
              ...
              <div className="flex flex-col-reverse md:flex-row-reverse lg:flex-row items-center mt-6 md:mt-0">
                ...
                <div className="border-2 border-[#e4563aef] py-6 px-8 mb-3 md:mb-0 rounded-full lg:ml-8 md:mr-8 ld:mr-0">
                  <h1 className="text-[24px] text-[#e4563aef] font-bold">03</h1>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-12 lg:col-span-4 flex flex-col justify-evenly items-center">
              ...
              <div className="flex lg:flex-row-reverse flex-col items-center mt-6 md:mt-0">
                <div className="border-2 border-[#e4563aef] py-6 px-8 mb-3 md:mb-0 rounded-full lg:ml-8 md:mr-8 ld:mr-0">
                  <h1 className="text-[24px] text-[#e4563aef] font-bold">04</h1>
                </div>
                <div>
                  <h2 className="leading-normal text-[#212121] mb-2 opacity-100 font-[poppins] font-medium text-base md:text-[24px] text-center lg:text-right">
                    Deployment & Launch
              ...
              <div className="flex lg:flex-row-reverse flex-col items-center mt-6 md:mt-0">
                <div className="border-2 border-[#e4563aef] py-6 px-8 mb-3 md:mb-0 rounded-full lg:ml-8 md:mr-8 ld:mr-0">
                  <h1 className="text-[24px] text-[#e4563aef] font-bold">05</h1>
                </div>
                <div>
                  <h2 className="leading-normal text-[#212121] mb-2 opacity-100 font-[poppins] font-medium text-base md:text-[24px] text-center lg:text-right">
                  ...
                  <p className="leading-normal text-[#212121] opacity-60 font-[poppins] font-medium text-base md:text-[18px] text-center lg:text-right">
                    Provide continuous support, updates, and enhancements to
                    keep the app optimized and up-to-date.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid  py-8 grid-cols-12 px-8 md:px-24">
          <div className="col-span-12 md:col-span-4flex justify-center items-start p-6">
            <div>
              ...
              <p className="leading-normal text-[#212121] opacity-100 md:pr-20 font-[poppins] font-medium text-base md:text-[18px] mb-8 text-justify">
                Success for a mobile app is measured by key performance
                indicators (KPIs) like user engagement, retention rates,
                downloads, and conversions. User feedback and reviews also
                provide insights for improvement. By monitoring these metrics,
                we ensure our apps deliver exceptional value and meet client
                goals.
              </p>
            </div>
          </div>
          <div className="col-span-12 md:col-span-4flex justify-center items-start p-6">
            <div>
              ...
              <p className="leading-normal text-[#212121] opacity-100 md:pr-20 font-[poppins] font-medium text-base md:text-[18px] mb-8 text-justify">
                The cost of an explainer video varies based on factors like
                video length, animation complexity, customization, and the
                production company's expertise. It can range from low-budget
                options (around $500 to $3,000) to mid-range choices (about
                $3,000 to $10,000) and high-end productions (starting from
                $10,000 and going up to $50,000 or more). Investing in a
                well-crafted explainer video can significantly impact brand
                image, customer engagement, and marketing efforts.
              </p>
            </div>
          </div>
          <div className="col-span-12 md:col-span-4flex justify-center items-start p-6">
            <div>
              ...
              <p className="leading-normal text-[#212121] opacity-100 md:pr-20 font-[poppins] font-medium text-base md:text-[18px] mb-8 text-justify">
                ...
                months to a year or more. Efficient planning and collaboration
                are crucial for meeting development timelines and delivering a
