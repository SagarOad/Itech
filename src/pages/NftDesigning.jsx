...
const NftDesigning = () => {
  ...
  useEffect(() => {
    ...
    metaDescription.content =
      "Top NFT development company we specialize in creating and managing non-fungible tokens.Our NFT developemnt service encompass smart contract creation, metadata integration and NFT marketplace startup.";
  ...
  return (
    <>
      <Helmet>
        <meta
          property="og:image"
          content="https://fameitech.net/assets/Nftss-e70630a2.png"
        />
      </Helmet>
      ...
      >
            ...
            <div className="px-8 md:px-24  flex flex-wrap flex-col md:flex-row items-center">
              <div className="flex flex-col w-full xl:w-[60%] justify-center lg:items-start ">
                ...
                <p className="leading-normal text-[#212121] opacity-75 pr-20 font-sans font-thin text-[20px] md:text-[20px] mb-8 md:text-left">
                  ...
                  we help bussiness to adopt blockchain technology and tokens to
                  create new products and services, improve their existing
                  operations and connect with their customer in new ways. <br />
        ...
        <div className="line-banner rounded-[50px]">
          <div className=" container mx-auto">
            ...
            <h1 className=" relative mt-4 mb-5 text-3xl sm:text-5xl md:text-[5rem] text-[#212121] font-[nexa] font-bold leading-tight  md:text-left">
                ...
                <div className="xl:col-span-9 col-span-12 flex flex-col justify-center">
                  <div className="2xl:mt-7.5 2xl:gap-7.5">
                    ...
                    <p className="leading-normal text-white font-sans font-medium md:text-[22px] mb-8">
                      A non-fungible token (NFT) is a term used to describe a
                      unique digital asset whose ownership is tracked using
                      Blockchain technologies, such as Ethereum. Assets that can
                      be represented as NFTs range from digital goods, such as
                      items that exist within virtual worlds, to even physical
                      goods authenticated on the blockchain. <br />
                      NFT marketing will take your brand beyond influencer
                      marketing, content marketing, media buying, email
                      marketing, video marketing and traditional social media
                      marketing. NFT assets connect the artist, with
                      communities, fans, and brands with ownable digital
                      content.
                    </p>
                  </div>
                </div>
